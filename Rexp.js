...
function compareData() {
    if (document.getElementById("account").value === "") {
        ...
        document.getElementById("usermessage").innerHTML = "您输入字符非法";
    }
}
...
function comparePData() {
    if (document.getElementById("password").value === "") {
        ...
        document.getElementById("passwordmesg").innerHTML = "您输入字符非法";
    }
...
function comparePRData() {
    ...
    if (!isPassword(document.getElementById("password-repeat").value)) {
        document.getElementById("password-repeat-mesg").innerHTML = "您输入字符非法";
    } else if (!(document.getElementById("password-repeat").value === document.getElementById("password").value)) {
        document.getElementById("password-repeat-mesg").innerHTML = "前后输入密码不一致";
    }
    else {
...
function compareEData() {
    if (document.getElementById("email").value === "") {
        ...
        document.getElementById("emailmessage").innerHTML = "您输入字符非法";
    } else {
        document.getElementById("emailmessage").innerHTML = "";
    }
}
...
function compareTData() {
    if (document.getElementById("telephone").value === "") {
        ...
        document.getElementById("telephonemesg").innerHTML = "您输入字符非法";
    } else {
        document.getElementById("telephonemesg").innerHTML = "";
    }
}
